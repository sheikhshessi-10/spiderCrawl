...
class BreadthFirstWebSpider(scrapy.Spider):
    ...
    def parse_level_1(self, response):
        ...
        # Check if we've finished all Level 0 pages and should start Level 1
        if (len(self.visited_urls) >= len(self.level_0_urls) + 1 and  # +1 for the A to Z index page
            not self.level_1_complete and 
            self.level_1_urls and 
